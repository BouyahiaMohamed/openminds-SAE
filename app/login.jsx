        ...
        <LinearGradient colors={['#2D2E5C', '#111226']} style={{ flex: 1 }}>
            <SafeAreaView style={{ flex: 1 }}>
                <View style={{ paddingTop: 48, paddingBottom: 24, paddingHorizontal: 24, alignItems: 'center' }}>
                    ...
                    <Text style={{ fontSize: 24, fontWeight: 'bold', color: 'white', marginBottom: 8 }}>Connectez-vous</Text>
                ...
                <View style={{ flex: 1, backgroundColor: '#13132C', borderTopLeftRadius: 25, borderTopRightRadius: 25, borderBottomLeftRadius: 25, borderBottomRightRadius: 25, marginHorizontal: 20, marginBottom: 32, paddingHorizontal: 24, paddingTop: 32, paddingBottom: 32, borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)', elevation: 10 }}>
                    <View style={{ gap: 24 }}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'flex-end', marginTop: -10 }}>
                            <TouchableOpacity>
                                <Text style={{ color: '#6C63FF', fontSize: 12, fontWeight: '500' }}>Mot de passe oublié</Text>
                            </TouchableOpacity>
                        </View>
                    ...
                    <View style={{ marginTop: 'auto', paddingTop: 24, flexDirection: 'row', justifyContent: 'center' }}>
                        <Text style={{ color: '#9CA3AF', fontSize: 12 }}>Pas de compte ? </Text>
                        <TouchableOpacity onPress={() => router.push('/register')}>
                            <Text style={{ color: '#6C63FF', fontSize: 12, fontWeight: '500' }}>En créer un</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </SafeAreaView>
